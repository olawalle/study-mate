      ...
      <div className="legends">
        <div className="legend vids">
          <p>
            <span
              style={{
                backgroundColor: data.data.datasets[0].backgroundColor[0],
              }}
            ></span>{" "}
            Completed Videos
          </p>
        ...
        <div className="legend left">
          <p>
            <span
              style={{
                backgroundColor: data.data.datasets[0].backgroundColor[1],
              }}
            ></span>{" "}
            Quiz
          </p>
        ...
        <div className="legend left">
          <p>
            <span
              style={{
                backgroundColor: data.data.datasets[0].backgroundColor[2],
              }}
            ></span>{" "}
            Mastery
          </p>
