...
export default function QuizQuestion(props) {
    ...
    const onSubmitFeedback = () => {
        const mainMessage = `${radioMessage ? radioMessage : ""} ${feedbackMessage ? feedbackMessage : ""}`;
        if (mainMessage) {
            const feedbackData = { message: mainMessage, subject: "Fedback from quiz", quizid: activeQuestion.id, userId: user.id }
            updateLoader(true);
            authServices
            ...
            {activeQuestion && (
                                        ...
                                        <div className="passage formm">
                                            ...
                                            <form>
                                                <span className="radio mt30">
                                                    <input type="radio" value={radioMessage} onChange={() => setradioMessage("The answer is wrong")} name="type" id="" />
                        The answer is wrong
                      </span>
              ...
              <span className="radio">
                ...
                The question or hit are confusing
                                                ...
                                                <span className="radio">
                                                    <input type="radio" value={radioMessage} onChange={() => setradioMessage("The image is not clear")} name="type" id="" />
                        The image is not clear
                                            ...
                                            <textarea value={feedbackMessage} onChange={({ target: { value } }) => setfeedbackMessage(value)} name="" id="" cols="30" rows="10"></textarea>
                                            <button onClick={onSubmitFeedback} className="tw-btn">Submit issue</button>
